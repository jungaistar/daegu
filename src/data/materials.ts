...
export const MATERIAL_CATEGORIES: MaterialCategory[] = [
  { id: 'intermediate', nameKo: '중급 · 업무자동화 자료', nameEn: 'Intermediate · Automation', icon: 'fa-bolt', descKo: 'AI 문서·엑셀 자동화와 데이터 분석 실무 학습자료입니다.', descEn: 'Materials on AI document/spreadsheet automation and data analysis.' },
  { id: 'advanced', nameKo: '고급 · 데이터분석 및 활용 자료', nameEn: 'Advanced · Data Analysis', icon: 'fa-chart-line', descKo: '바이브코딩 도구 제작·데이터 분석 심화·AI 정책 홍보 콘텐츠 학습자료입니다.', descEn: 'Materials on vibe-coding tools, advanced analysis, and AI PR content.' },
];

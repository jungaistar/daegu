import{C as A,I as K,r as x,l as e}from"./index-CoA2zF9x.js";import{u as P,A as T,K as k,S as I,T as E}from"./SubscribePrompt-DQPcT4ni.js";import{u as R,A as $}from"./useApiKeys-CEDqSCLH.js";import{S as D}from"./SEOHead-B86Ulpzq.js";import"./useUsageLog-Ju2lq4z7.js";import"./index-CTy_MeS4.js";function F({minutes:l,meetingName:n,department:c,decisionCount:r,reportTo:m,language:d}){return[{role:"system",content:`You are a meeting secretary in a Korean local government office. You organize raw minutes into decisions and action items, and you never invent decisions that were not discussed. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 회의록을 보고용으로 정리해주세요.

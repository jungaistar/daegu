import{C,I,r as g,l as e}from"./index-Bo10ZyG3.js";import{u as P,A as R,K,S as k,T}from"./SubscribePrompt-rV7vSrty.js";import{u as E,A as F}from"./useApiKeys-BE6L_UDl.js";import{S as $}from"./SEOHead-Btr7Ns9r.js";import"./useUsageLog-DnOQ8sw0.js";import"./index-BqqwUJVv.js";function D({document:i,docType:o,audience:c,focus:n,language:d}){return[{role:"system",content:`You are an internal auditor reviewing documents before they leave a Korean local government office. You flag risks precisely and state clearly when an item is fine. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 문서를 발송 전 관점에서 검토해주세요.

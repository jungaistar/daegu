import{C as D,I,r as j,l as e}from"./index-B4dcRgE5.js";import{u as K,A as T,K as w,S as k,T as P}from"./SubscribePrompt-CgpPkt7z.js";import{u as $,A as E}from"./useApiKeys--14xGh8W.js";import{S as F}from"./SEOHead-D5Knz0BO.js";import"./useUsageLog-DI121MVF.js";import"./index-C2T2D3R5.js";function R({docType:r,department:l,subject:c,facts:t,audience:d,tone:u,length:m,language:f}){return[{role:"system",content:`You are an experienced administrative officer at Daegu Metropolitan City Hall who drafts official documents. You follow Korean public-sector document conventions precisely and never invent facts. Always respond in ${f==="ko"?"한국어":"English"}.`},{role:"user",content:`다음 정보로 ${r||"안내 공문"} 초안을 작성해주세요.

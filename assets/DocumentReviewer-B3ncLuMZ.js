import{C,I,r as g,l as e}from"./index-bPHOlBSv.js";import{u as P,A as R,K,S as k,T}from"./SubscribePrompt-B81F9WXX.js";import{u as E,A as F}from"./useApiKeys-a1m01sNa.js";import{S as $}from"./SEOHead-BOPenNwz.js";import"./useUsageLog-BHUhIScJ.js";import"./index-DEmZ24Wf.js";function D({document:i,docType:o,audience:c,focus:n,language:d}){return[{role:"system",content:`You are an internal auditor reviewing documents before they leave a Korean local government office. You flag risks precisely and state clearly when an item is fine. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 문서를 발송 전 관점에서 검토해주세요.

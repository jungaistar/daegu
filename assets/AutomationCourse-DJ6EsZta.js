import{C as n,l as e,L as a}from"./index-CQ9qpIGg.js";import{G as i}from"./GuidePage-1nifLkjY.js";/* empty css                 */import"./SEOHead-BcMQzIix.js";import"./index-BxAVG7k_.js";import"./index-w_rM-wnT.js";const s={id:"auto-overview",icon:"fa-map",title:"과정 개요 · 시간표",titleEn:"Overview & Schedule",sections:[{title:"이 과정은 이렇게 진행됩니다",titleEn:"How This Course Runs",content:`**바이브코딩 기반 행정업무 자동화 도구 제작** — 하루 8시간, 강사 정동엽.
...
Nobody built twelve at once. It starts with **the one task that eats 30 minutes a week** — which you built today.`}]};function k(){const{language:o}=n(),t=o==="ko";return e.jsx(i,{seoTitle:"행정업무 자동화",seoTitleEn:"Administrative Automation",seoDescription:"바이브코딩 기반 행정업무 자동화 도구 제작 — 1일 8시간 과정. 교시별 따라하기 실습과 대구시 부서별 사례집",path:"/automation",dataFiles:[s,r,l,h,c,d,u,p,m],ctaBanner:e.jsxs("div",{className:"prompt-practice-cta",children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"이 과정을 처음 보신다면":"New to this course?"}),e.jsx("p",{children:t?"위 목차의 「과정 개요 · 시간표」부터 순서대로 보세요. 각 교시는 그대로 따라 하면 되는 단계로 되어 있습니다.":'Start with "Overview & Schedule" above. Each session is written as steps you can follow directly.'})]}),e.jsxs(a,{to:"/prompt-eval",className:"prompt-practice-cta-btn",children:[e.jsx("i",{className:"fa-solid fa-keyboard"}),t?"프롬프트 기초 먼저 보기":"Prompt basics first"]})]})})}export{k as default};

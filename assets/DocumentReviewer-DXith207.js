import{C,I,r as g,l as e}from"./index-i6kh4N1s.js";import{u as P,A as R,K,S as k,T}from"./SubscribePrompt-DIv7Foah.js";import{u as E,A as F}from"./useApiKeys-CRs-mPQh.js";import{S as $}from"./SEOHead-B0BAGuBs.js";import"./useUsageLog-B_Bo7_Mf.js";import"./index-AXnKaWji.js";function D({document:i,docType:o,audience:c,focus:n,language:d}){return[{role:"system",content:`You are an internal auditor reviewing documents before they leave a Korean local government office. You flag risks precisely and state clearly when an item is fine. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 문서를 발송 전 관점에서 검토해주세요.

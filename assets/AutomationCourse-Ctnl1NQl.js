import{C as n,l as e,L as s}from"./index-CoA2zF9x.js";import{G as i}from"./GuidePage-DfuEQJlF.js";/* empty css                 */import"./SEOHead-B86Ulpzq.js";import"./index-CTy_MeS4.js";import"./index-4LzFPJJ5.js";const a={id:"auto-overview",icon:"fa-map",title:"과정 개요 · 시간표",titleEn:"Overview & Schedule",sections:[{title:"이 과정은 이렇게 진행됩니다",titleEn:"How This Course Runs",content:`**바이브코딩 기반 행정업무 자동화 도구 제작** — 하루 8시간, 강사 정동엽.
...
> Save this document — Sessions 3 and 4 use it continuously.`}]},c={id:"auto-03",icon:"fa-pen-ruler",title:"3교시 11:00~12:00 · 업무흐름 및 화면구성 설계",titleEn:"Session 3 — Flow and Screen Design",sections:[{title:"만들기 전에 그림을 그립니다",titleEn:"Draw It Before You Build It",content:`### 이 시간에 하는 일
...
> Take this spec straight into Session 4.`}]},h={id:"auto-04",icon:"fa-wand-magic-sparkles",title:"4교시 13:00~14:00 · 자동화 코드·템플릿 생성",titleEn:"Session 4 — Generating Code",sections:[{title:"프롬프트를 넣고 코드를 받습니다",titleEn:"Paste the Prompt, Get the Code",content:`### 이 시간에 하는 일
...
Do not start over — ask it to change only the specific part and show the whole code again.`}]},p={id:"auto-05",icon:"fa-bug",title:"5교시 14:00~15:00 · 구현 및 테스트",titleEn:"Session 5 — Build and Test",sections:[{title:"돌려보고, 틀리면 AI에게 다시 시킵니다",titleEn:"Run It, and Send Errors Back to the AI",content:`### 이 시간에 하는 일
...
Insert → Drawing → draw a rectangle with a label → Save → click the image → ⋮ → Assign script → enter the function name. Buttons beat menus when handing the tool to a colleague.`}]},d={id:"auto-06",icon:"fa-shield-halved",title:"6교시 15:00~16:00 · 보안·오류 대응 및 개선",titleEn:"Session 6 — Security and Error Handling",sections:[{title:"공공업무에 쓸 수 있게 다듬습니다",titleEn:"Make It Safe for Public Service",content:`### 이 시간에 하는 일
...
Nobody built twelve at once. It starts with **the one task that eats 30 minutes a week** — which you built today.`}]};function b(){const{language:o}=n(),t=o==="ko";return e.jsx(i,{seoTitle:"행정업무 자동화",seoTitleEn:"Administrative Automation",seoDescription:"바이브코딩 기반 행정업무 자동화 도구 제작 — 1일 8시간 과정. 교시별 따라하기 실습과 대구시 부서별 사례집",path:"/automation",dataFiles:[a,r,l,c,h,p,d,u,m],ctaBanner:e.jsxs("div",{className:"prompt-practice-cta",children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"이 과정을 처음 보신다면":"New to this course?"}),e.jsx("p",{children:t?"위 목차의 「과정 개요 · 시간표」부터 순서대로 보세요. 각 교시는 그대로 따라 하면 되는 단계로 되어 있습니다.":'Start with "Overview & Schedule" above. Each session is written as steps you can follow directly.'})]}),e.jsxs(s,{to:"/prompt-eval",className:"prompt-practice-cta-btn",children:[e.jsx("i",{className:"fa-solid fa-keyboard"}),t?"프롬프트 기초 먼저 보기":"Prompt basics first"]})]})})}export{b as default};

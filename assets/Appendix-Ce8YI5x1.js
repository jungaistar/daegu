import{l as e}from"./index-CoA2zF9x.js";import{G as t}from"./GuidePage-DfuEQJlF.js";/* empty css                 */import"./SEOHead-B86Ulpzq.js";import"./index-CTy_MeS4.js";import"./index-4LzFPJJ5.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Keep the original photo — you will need it to regenerate.`},{title:"따라하기 ⑥ 내 사진을 그림 화풍으로 바꾸기",titleEn:"Walkthrough 6 — Convert Your Photo to an Illustrated Style",content:`**소요 20분 · 준비물: 인물이 크게 나온 사진 1장**
...
> For anything public-facing, check your organization's AI-use policy first — it takes precedence over this page.`},{title:"막힐 때 이렇게 해보세요",titleEn:"When You Get Stuck",content:`### 원하는 그림이 안 나와요
...
> Stuck? Come back to Appendix → Glossary and Practical Tips.`}]};function p(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 챗봇 활용법, 파일 요약·문서 정리, 이미지 만들기, AI 모델 고르기, 실전 팁, 함께 공부할 자료 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,o,n,i,s,r,l]})}export{p as default};

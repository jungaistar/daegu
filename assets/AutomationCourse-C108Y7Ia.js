import{C as o,l as e,L as i}from"./index-BrGMx2_T.js";import{G as s}from"./GuidePage-CB9H4e2i.js";/* empty css                 */import"./SEOHead-BOR2dgqX.js";import"./index-CYM3Tcsi.js";import"./index-ByXXgH3E.js";const a={id:"auto-overview",icon:"fa-map",title:"과정 개요 · 시간표",titleEn:"Overview & Schedule",sections:[{title:"이 과정은 이렇게 진행됩니다",titleEn:"How This Course Runs",content:`**바이브코딩 기반 행정업무 자동화 도구 제작** — 하루 8시간, 강사 정동엽.
...
Task definition, design and prompt, **working tool**, error checklist and security notes, one-page user guide, rollout plan, improvements and a three-week plan.`}]},g={id:"auto-08",icon:"fa-list-check",title:"실습 사례집 · 부서별 적용",titleEn:"Case Library by Division",sections:[{title:"내 부서 업무로 골라 쓰기",titleEn:"Pick the Case That Matches Your Work",content:`2교시에 고를 업무가 떠오르지 않으면 여기서 찾으세요. **대구시 부서에서 실제로 반복되는 업무**를 기준으로 정리했습니다.
...
Nobody built twelve at once. It starts with **the one task that eats 30 minutes a week** — which you built today.`}]};function y(){const{language:n}=o(),t=n==="ko";return e.jsx(s,{seoTitle:"행정업무 자동화",seoTitleEn:"Administrative Automation",seoDescription:"바이브코딩 기반 행정업무 자동화 도구 제작 — 1일 8시간 과정. 교시별 따라하기 실습과 대구시 부서별 사례집",path:"/automation",dataFiles:[a,r,l,c,p,d,h,u,g],ctaBanner:e.jsxs("div",{className:"prompt-practice-cta",children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"이 과정을 처음 보신다면":"New to this course?"}),e.jsx("p",{children:t?"위 목차의 「과정 개요 · 시간표」부터 순서대로 보세요. 각 교시는 그대로 따라 하면 되는 단계로 되어 있습니다.":'Start with "Overview & Schedule" above. Each session is written as steps you can follow directly.'})]}),e.jsxs(i,{to:"/prompt-eval",className:"prompt-practice-cta-btn",children:[e.jsx("i",{className:"fa-solid fa-keyboard"}),t?"프롬프트 기초 먼저 보기":"Prompt basics first"]})]})})}export{y as default};

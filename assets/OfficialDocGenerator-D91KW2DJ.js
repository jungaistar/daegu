import{C as D,I,r as j,l as e}from"./index-BrGMx2_T.js";import{u as K,A as T,K as w,S as k,T as P}from"./SubscribePrompt-ZRNzEso-.js";import{u as $,A as E}from"./useApiKeys-DLYBNG5-.js";import{S as F}from"./SEOHead-BOR2dgqX.js";import"./useUsageLog-KCj47Sw9.js";import"./index-CYM3Tcsi.js";function R({docType:r,department:l,subject:c,facts:t,audience:d,tone:u,length:m,language:f}){return[{role:"system",content:`You are an experienced administrative officer at Daegu Metropolitan City Hall who drafts official documents. You follow Korean public-sector document conventions precisely and never invent facts. Always respond in ${f==="ko"?"한국어":"English"}.`},{role:"user",content:`다음 정보로 ${r||"안내 공문"} 초안을 작성해주세요.

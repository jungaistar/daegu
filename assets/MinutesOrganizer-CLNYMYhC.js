import{C as A,I as K,r as x,l as e}from"./index-bPHOlBSv.js";import{u as P,A as T,K as k,S as I,T as E}from"./SubscribePrompt-B81F9WXX.js";import{u as R,A as $}from"./useApiKeys-a1m01sNa.js";import{S as D}from"./SEOHead-BOPenNwz.js";import"./useUsageLog-BHUhIScJ.js";import"./index-DEmZ24Wf.js";function F({minutes:l,meetingName:n,department:c,decisionCount:r,reportTo:m,language:d}){return[{role:"system",content:`You are a meeting secretary in a Korean local government office. You organize raw minutes into decisions and action items, and you never invent decisions that were not discussed. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 회의록을 보고용으로 정리해주세요.

import{l as e}from"./index-DuCL8CH-.js";import{G as t}from"./GuidePage-BGF26jUI.js";/* empty css                 */import"./SEOHead-DBlgeakt.js";import"./index-4_63dkSj.js";import"./index-g1lIdO2v.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Stuck? Come back to Appendix → Glossary and Practical Tips.`}]};function g(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 챗봇 활용법, 파일 요약·문서 정리, AI 모델 고르기, 실전 팁, 함께 공부할 자료 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,n,i,o,s,r]})}export{g as default};

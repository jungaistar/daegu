import{C as A,I as K,r as x,l as e}from"./index-JG4ThUyr.js";import{u as P,A as T,K as k,S as I,T as E}from"./SubscribePrompt-g64M5FBM.js";import{u as R,A as $}from"./useApiKeys-B2znN_GT.js";import{S as D}from"./SEOHead-B9XOKaPu.js";import"./useUsageLog-DSg6uQ4s.js";import"./index-1FQm8cvG.js";function F({minutes:l,meetingName:n,department:c,decisionCount:r,reportTo:m,language:d}){return[{role:"system",content:`You are a meeting secretary in a Korean local government office. You organize raw minutes into decisions and action items, and you never invent decisions that were not discussed. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 회의록을 보고용으로 정리해주세요.

import{l as t}from"./index-sJe1uxHu.js";import{G as e}from"./GuidePage-BiwH3aLq.js";/* empty css                 */import"./SEOHead-D5voCWqp.js";import"./index-B7b1E6Pu.js";import"./index-W0ZNvzdY.js";const o={id:"ref-intro",icon:"fa-user-gear",title:"광진구 류승인 주무관 사례",titleEn:"The Case of Ryu Seung-in",sections:[{title:"누구인가",titleEn:"Who He Is",content:`### 프로필
...
> **The school web app (school.gomdori.app) is currently returning a server error.** The same capability is available over MCP — see step 2.`},{title:"2단계 · AI에 MCP 도구 연결하기",titleEn:"Step 2 — Connect MCP Tools to Your AI",content:`> ### 화면 그림을 보며 따라 하시려면
> **[▶ Claude에 공공데이터 연결하기 — 따라하기](/setup/mcp)** 로 가세요.
> 앱 설치부터 첫 질문까지 **7단계**를, 화면 그림 위의 파란 번호를 짚어가며 안내합니다. 단계마다 체크하면 어디까지 했는지 저장되고, "이 화면이 안 나오면" 대응도 단계마다 붙어 있습니다.

import{l as e}from"./index-i6kh4N1s.js";import{G as t}from"./GuidePage-2NBmRHrG.js";/* empty css                 */import"./SEOHead-B0BAGuBs.js";import"./index-AXnKaWji.js";import"./index-DXBdIGdD.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
That is all there is to it. The rest is repetition.`}]},i={id:"ai-models",icon:"fa-microchip",title:"AI 모델 고르기",titleEn:"Choosing a Model",sections:[{title:"한눈에 고르는 법",titleEn:"Quick Guide",content:`> AI 플랫폼에서는 여러 회사의 AI 모델을 골라 쓸 수 있습니다. **잘 모르겠으면 \`Auto(자동)\`** — 작업에 맞는 모델을 알아서 골라줍니다. 표시 뜻: **(고비용)** = 요금이 많이 드니 꼭 필요할 때만 · **(New)** = 최신 모델.
...
| Grok Code Fast | coding | fast code tasks | |`}]},o={id:"tips",icon:"fa-lightbulb",title:"실전 팁",titleEn:"Practical Tips",sections:[{title:"좋은 답을 얻는 프롬프트 팁",titleEn:"Tips for Better Prompts",content:`같은 AI라도 어떻게 묻느냐에 따라 결과가 크게 달라집니다.
...
- Always minimize sensitive data when using AI for work.`}]},s={id:"resources",icon:"fa-graduation-cap",title:"함께 공부할 자료",titleEn:"Study Together",sections:[{title:"과정별 추천 학습 순서",titleEn:"Recommended Learning Path",content:`교육이 끝난 뒤에도 스스로 이어서 공부할 수 있도록 순서를 제안합니다.
...
> Stuck? Come back to Appendix → Glossary and Practical Tips.`}]};function m(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 챗봇 활용법 따라하기, AI 모델 고르기, 실전 팁, 함께 공부할 자료 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,n,i,o,s]})}export{m as default};

import{C as w,I as R,r as f,l as e}from"./index-JG4ThUyr.js";import{u as K,A as P,K as k,S as I,T as E}from"./SubscribePrompt-g64M5FBM.js";import{u as F,A as T}from"./useApiKeys-B2znN_GT.js";import{S as $}from"./SEOHead-B9XOKaPu.js";import"./useUsageLog-DSg6uQ4s.js";import"./index-1FQm8cvG.js";function D({complaint:o,department:t,category:c,stance:r,tone:m,basis:p,language:d}){return[{role:"system",content:`You are a civil affairs officer at Daegu Metropolitan City Hall drafting replies to citizen complaints. You are courteous, concrete, and never promise anything without a stated basis. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 민원에 대한 답변 초안을 작성해주세요.

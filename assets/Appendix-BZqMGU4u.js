import{l as e}from"./index-BsivOiw6.js";import{G as t}from"./GuidePage-BkqIqQt2.js";/* empty css                 */import"./SEOHead-BITSreP1.js";import"./index-C-24k3ac.js";import"./index-C5xtSpW3.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
That is all there is to it. The rest is repetition.`}]},o={id:"file-doc",icon:"fa-folder-tree",title:"파일 요약 · 문서 정리",titleEn:"Summarize Files, Organize Documents",sections:[{title:"세 도구 중 무엇을 쓸까",titleEn:"Which of the Three to Use",content:`파일을 요약하고 문서를 정리하는 일은 **ChatGPT · Gemini · Claude 셋 다 할 수 있습니다.** 다만 잘하는 결이 조금씩 다릅니다.
...
| A conversational AI for drafting the wording (example) |`},{title:"막힐 때 이렇게 해보세요",titleEn:"When You Get Stuck",content:`### 원하는 그림이 안 나와요
...
> Stuck? Come back to Appendix → Glossary and Practical Tips.`}]};function p(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 챗봇 활용법, 파일 요약·문서 정리, 이미지 만들기, AI 모델 고르기, 실전 팁, 함께 공부할 자료 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,n,o,i,s,r,l]})}export{p as default};

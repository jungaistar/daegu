import{C,I,r as g,l as e}from"./index-BDazC5Vi.js";import{u as P,A as R,K,S as k,T}from"./SubscribePrompt-BUwBm7LD.js";import{u as E,A as F}from"./useApiKeys-T0qZju0i.js";import{S as $}from"./SEOHead-703oy1oQ.js";import"./useUsageLog-xW5cyP4p.js";import"./index-CSt1uRs7.js";function D({document:i,docType:o,audience:c,focus:n,language:d}){return[{role:"system",content:`You are an internal auditor reviewing documents before they leave a Korean local government office. You flag risks precisely and state clearly when an item is fine. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`아래 문서를 발송 전 관점에서 검토해주세요.

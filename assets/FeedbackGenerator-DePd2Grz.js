import{C as S,I as A,r as j,l as e}from"./index-Cg4_QEuX.js";import{u as C,A as I,K as $,S as F,T as w}from"./SubscribePrompt-CbnyuDiD.js";import{u as E,A as K}from"./useApiKeys-BJq0fiR1.js";import{S as P}from"./SEOHead-4lO7HTjQ.js";import"./useUsageLog--7DgCv2f.js";import"./index-nGRoBTTF.js";function T({studentName:s,courseName:n,assignmentName:d,grade:t,strengths:i,improvements:c,tone:m,language:u}){const g=u==="ko"?"한국어":"English",p={encouraging:"격려하는",constructive:"건설적인",formal:"공식적인",friendly:"친근한"};return[{role:"system",content:`You are an experienced educator who provides thoughtful, personalized feedback to students. Your feedback should be specific, actionable, and motivating. Always respond in ${g}.`},{role:"user",content:`다음 정보를 바탕으로 학생 개인화 피드백을 작성해주세요.

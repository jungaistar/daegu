import{C as A,I as K,r as x,l as e}from"./index-JG4ThUyr.js";import{u as w,A as k,K as I,S as R,T as E}from"./SubscribePrompt-g64M5FBM.js";import{u as $,A as F}from"./useApiKeys-B2znN_GT.js";import{S as T}from"./SEOHead-B9XOKaPu.js";import"./useUsageLog-DSg6uQ4s.js";import"./index-1FQm8cvG.js";function D({program:i,department:r,facts:c,audience:o,channel:m,tone:p,language:d}){return[{role:"system",content:`You are a press officer at the Daegu Metropolitan City spokesperson's office. You write press releases in the standard Korean public-institution style and never fabricate figures. Always respond in ${d==="ko"?"한국어":"English"}.`},{role:"user",content:`다음 정보로 시정 보도자료 초안을 작성해주세요.

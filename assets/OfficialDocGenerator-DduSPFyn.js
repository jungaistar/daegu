import{C as D,I,r as j,l as e}from"./index-BoVXmbxw.js";import{u as K,A as T,K as w,S as k,T as P}from"./SubscribePrompt-DSaEl1wb.js";import{u as $,A as E}from"./useApiKeys-noy5VAHo.js";import{S as F}from"./SEOHead-DL2xn5uX.js";import"./useUsageLog-hWEMbnGn.js";import"./index-Cuf4nFEQ.js";function R({docType:r,department:l,subject:c,facts:t,audience:d,tone:u,length:m,language:f}){return[{role:"system",content:`You are an experienced administrative officer at Daegu Metropolitan City Hall who drafts official documents. You follow Korean public-sector document conventions precisely and never invent facts. Always respond in ${f==="ko"?"한국어":"English"}.`},{role:"user",content:`다음 정보로 ${r||"안내 공문"} 초안을 작성해주세요.
